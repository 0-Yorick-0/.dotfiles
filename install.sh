...
source "$DOTFILES/install/install-alacritty.sh"
source "$DOTFILES/install/install-vim.sh"
source "$DOTFILES/install/install-sketchybar.sh"
source "$DOTFILES/install/install-spotify.sh"
source "$DOTFILES/install/install-yabai.sh"
