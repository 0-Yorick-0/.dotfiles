return {
	...
	g = {
		name = "Golang",
		fr = { "<cmd>GoCallers<CR>", "[F]ind[R]eferences" },
		im = { "<cmd>GoImplements<CR>", "go to [Im]plementations" },
		rl = { "<cmd>GoModReload<CR>", "[R]eload Modules" },
		imp = { "<cmd>GoImport<CR>", "[Imp]ort module" },
		x = { "<cmd>GoDocBrowser<CR>", "[Doc] in Browser" },
